...
trait TeamScope
{
    protected static function bootTeamScope()
    {
        static::addGlobalScope('team', function (Builder $builder) {
            ...
            // Bypass scoping for marketplace routes
            if (request()->is('marketplace*') || request()->routeIs('marketplace.*')) {
                return;
            }
        ...
        static::creating(function ($model) {
            ...
            $currentTenantId = Auth::check() ? Auth::user()->tenant_id : (function_exists('tenant') ? tenant('id') : null);
            ...
            if ($currentTenantId) {
                if ($hasTenantId && ! isset($model->tenant_id)) {
